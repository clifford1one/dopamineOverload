...
de cómo el diseño UI permite y fabrica escenarios adictivos. Muchas veces con el propósito de causar adicciones en sus usuarios.
...
En la vida, el feedback es escaso y lejano. Los juegos permiten obtener recompensas rápidas, entendibles y "fáciles".
...
En la vida no sabemos si estamos tomando la decisión correcta, pero en el pong, se exactamente que tengo que hacer si quiero triunfar.
...
8. mesmerize yourself into ritual(keystone habits)
...
Si bien, la dopamina es necesaria para sentirse feliz, no es la molécula de la felicidad en sí. [fuente](https://today.uconn.edu/2012/11/uconn-researcher-dopamine-not-about-pleasure-anymore/)

### esta parte es importante

balance: una subida de dopamina conlleva una bajada de la misma magnitud. esto se debe a que el cuerpo busca estar constantemente en estado de [homeostasis](https://es.wikipedia.org/wiki/Homeostasis)
...
distintos estímulos provocan distintas reacciones. Cosas como la comida chatarra, videojuegos, celular, porno, etc. causan caídas abruptas en el balance de dopamina.
 ...
 al usar estos estímulos fáciles(TikTok, papas fritas, etc) se generan picos altos de dopamina, al dejar estos estímulos, se generan picos bajos "fast dopamine". sin embargo para retornar a niveles normales, los niveles van subiendo lentamente "slow dopamine"
...
así se generan adicciones. si te consideras adicto a TikTok, no eres adicto a TikTok, eres adicto a evitar y escapar del estado en el que te encuentras cuando no está viendo TikTok.

 cuando te sientes "inmutable" y sientes que estímulos naturales (como socializar, ver la naturaleza, museos, etc) no te hacen efecto, es porque no tienen los receptores de dopamina disponibles para eso. Para tenerlos disponibles, debes intentar tener la la balanza inclinada hacia el otro lado. Para que tu cuerpo busque la homeostasis a través de liberar dopamina ante estímulos "naturales"(no TikTok)
...
B.F. Skinner fue un sicólogo e inventor gringo. Uno de sus experimentos más famosos es la skinner box, donde sometía palomas a distintos tipos de recompensas:
...
tanto para los sujetos de estudio como para los humanos, un ratio variables es mucho más adictivo que un ratio fijo. Este es el fenómeno que hace adictivos las slot machines, loot boxes, TikTok, etc.
}
...
why our screen makes us less happy{
  ...
  de una de las cosas que habla Adam Alter, que me parecieron más interesantes. es la siguiente:

  con actividades las cuales,  separa en 2 categorías. las cuales al interrumpir a una persona haciéndola, te dice que le gusta esa actividad, o que se siente bien haciéndola; y aquellas que al interrumpir a una persona haciéndola, te responde que no le gusta o que no se siente bien haciendo esa actividad.

  en  promedio las personas pasan 9 minutos al día en cada una de esas actividades del primer grupo. Y 27 minutos al día en cada una de esas actividades del 2do grupo.
...
- excitement and unpredictability, intermittent reinforcement
